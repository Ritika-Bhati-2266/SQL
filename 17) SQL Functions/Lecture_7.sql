...
-- Total quantity available of all electronics products
SELECT SUM(quantity)AS electronics_quantity
FROM products
WHERE category='Electronics';


-- Total quantity available of all electronics products and price>20000
SELECT SUM(quantity)AS electronics_quantity
FROM products
...
SELECT AVG(price) AS averagr_price
FROM products
