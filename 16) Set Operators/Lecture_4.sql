...
-- 2) UNION -- Combines results, keep duplicates
SELECT student_name, course 
FROM student_2023
UNION ALL
SELECT student_name, course
...
-- 3) INTERSECT -Returns common results in both tables
SELECT student_name, course
FROM student_2023
INTERSECT
SELECT student_name, course
...
-- 4) EXCEPT --Returns result in the first table but not in the second
SELECT student_name, course
FROM student_2023
EXCEPT
SELECT student_name, course
